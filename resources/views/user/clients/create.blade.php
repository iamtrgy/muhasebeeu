                    ...
                    <div class="flex items-center text-sm">
                        <nav class="flex min-w-full" aria-label="Breadcrumb">
                            <ol role="list" class="flex items-center space-x-2">
                                ...
                                <li>
                                    <a href="{{ route('user.clients.index') }}" class="text-sm font-medium text-gray-500 hover:text-gray-900 dark:hover:text-gray-300">
                                        Clients
                                    </a>
                                </li>
                                <li class="text-gray-400">/</li>
                                <li>
                                    <span class="text-sm font-medium text-gray-900 dark:text-gray-100">Create New Client</span>
                                </li>
                            </ol>
                        </nav>
                    </div>
