        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @else
                        <form action="{{ route('user.files.classification.bulk') }}" method="POST" id="bulk-classify-form">
                            @csrf
                                            ...
                                            <div class="p-4">
                                                ...
                                                <div class="mb-3 text-sm">
                                                    <div class="flex items-center mb-1">
                                                        ...
                                                        <span class="text-gray-900 dark:text-gray-100">{{ $file->folder->path ?? 'Unknown' }}</span>
                                                    </div>
                                                    <div class="flex items-center">
                                                        <span class="text-gray-500 dark:text-gray-400 w-20">Suggested:</span>
                                                        <span class="text-green-600 dark:text-green-400 font-medium">{{ $file->suggestedFolder->path ?? 'Unknown' }}</span>
                                                    </div>
                                                </div>
                                                
                                                <div class="flex justify-end space-x-2">
                                                    <a href="{{ route('user.files.classification.show', $file) }}" class="inline-flex items-center px-3 py-1.5 border border-blue-600 text-blue-600 rounded text-sm hover:bg-blue-600 hover:text-white transition duration-150">
                                        ...
                                        @foreach($pendingFiles as $file)
                                            <tr class="content-row">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    <a href="{{ route('user.files.classification.show', $file) }}" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300">
                                                        Review
                                                    </a>
                                                </td>
                                            </tr>
