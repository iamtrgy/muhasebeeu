<x-admin-layout>
    <x-slot name="header">
        <x-admin.page-title title="{{ __('Create New Company') }}"></x-admin.page-title>
    </x-slot>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.companies.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="foundation_date" name="foundation_date" type="date" class="mt-1 block w-full" :value="old('foundation_date')" />
